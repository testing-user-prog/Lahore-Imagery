...
from src.imageeditor.qualityeditor import GaussianImageBlur
import cv2
...
grey1=cv2.imread('src/dataset/2014.png',cv2.IMREAD_GRAYSCALE)
grey2=cv2.imread('src/dataset/2015.png',cv2.IMREAD_GRAYSCALE)
